...
public interface coords_converter {
	 ...
	 * @param gps1 represent a gps point 
     * @param gps0 represent a gps point
     * @return the elevation and azimuth and the distance between 2 points
	 * */
	public double[] azimuth_elevation_dist(Point3D gps0, Point3D gps1);
	/**
	 * return true iff this point is a valid lat, lon , lat coordinate: [-180,+180],[-90,+90],[-450, +inf]
	 * @param p represent the point we want to check
